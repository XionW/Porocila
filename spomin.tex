...
Vlogo temporalnega režnja pri tvorbi spominov so potrdili tudi poizkusom na opicah vrste Macaque, katerih možgani so podobni človeškim. S poškodbami temporalnih režnjev so okvarili delovanje kratkoročnega spomina, kar je vidno na rezultatih testa DNMS (delayed non-match to sample). Opice s poškodovanimi temporalnimi režnji so test opravile uspešno, če je bil čas med poizkusi kratek (informacije so bile še vedno v delovnem spominu), ko pa se je čas med poizkusi podaljšal, pa je uspešnost opic izrazito padla. Kontrolna skupina opic pri daljšem času med poskusi ni pokazala očitnega padca uspešnosti.
